import { IAnnotationTemplatePublisher } from '../../application/ports/IAnnotationTemplatePublisher';
  ...
  implements IAnnotationTemplatePublisher
{
  ...
  async unpublish(
    ...
    if (this.publishedRecords.has(uri)) {
      ...
      console.log(`[FakeAnnotationTemplatePublisher] Unpublished record ${uri}`);
