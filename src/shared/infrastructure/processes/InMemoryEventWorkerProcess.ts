...
export class InMemoryEventWorkerProcess implements IProcess {
  ...
  async start(): Promise<void> {
    ...
    const repositories = RepositoryFactory.create(this.configService);
    const services = ServiceFactory.createForWorker(this.configService, repositories);
  ...
  private async registerHandlers(
    ...
    const feedCardAddedToLibraryHandler = new FeedCardAddedToLibraryEventHandler(
      cardCollectionSaga,
    );
    const cardAddedToCollectionHandler = new CardAddedToCollectionEventHandler(
      cardCollectionSaga,
    ...
    // Search handlers
    const searchCardAddedToLibraryHandler = new SearchCardAddedToLibraryEventHandler(
