...
export class AddAnnotationFieldToTemplateUseCase {
  ...
  async execute(input: { templateId: TID; fieldRef: StrongRef; required?: boolean }): Promise<void> {
    // 1. Validate input
    ...
    console.log('Executing AddAnnotationFieldToTemplateUseCase with input:', input)
