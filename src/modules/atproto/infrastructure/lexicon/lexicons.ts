...
export const ids = {
  AppAnnosAnnotation: "network.cosmik.annotation",
  AppAnnosAnnotationField: "network.cosmik.annotationField",
  AppAnnosAnnotationTemplate: "network.cosmik.annotationTemplate",
  ...
  AppAnnosDefs: "network.cosmik.defs",
