import {
  NoteCardContent,
  NoteCardContentValidationError,
} from "../../../../domain/value-objects/content/NoteCardContent";
...
describe("NoteCardContent", () => {
  describe("creation", () => {
    ...
    it("should reject empty text", () => {
      ...
      expect(
        (result as Err<NoteCardContent, NoteCardContentValidationError>).error
      ).toBeInstanceOf(NoteCardContentValidationError);
      expect(
        (result as Err<NoteCardContent, NoteCardContentValidationError>).error
          .message
  ...
  describe("title updates", () => {
    it("should update title successfully", () => {
      const content = NoteCardContent.create(
        "Test text",
        "Original Title"
      ).unwrap();
  ...
  describe("immutability", () => {
    it("should not modify original content when updating text", () => {
      const originalContent = NoteCardContent.create(
        "Original text",
        "Original Title"
      ).unwrap();
