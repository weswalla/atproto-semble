    ...
    case "triad":
      try {
        ...
        return {
          type: "triad",
          vertexA:
            parsedValue.vertexA === "" ? 0 : parseFloat(parsedValue.vertexA),
          vertexB:
            parsedValue.vertexB === "" ? 0 : parseFloat(parsedValue.vertexB),
          vertexC:
            parsedValue.vertexC === "" ? 0 : parseFloat(parsedValue.vertexC),
        } as TriadValue;
      } catch (e) {
