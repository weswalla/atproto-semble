  ...
  AnnotationFieldMapper: {
    toDTO: jest.fn((field: AnnotationField) => ({
      ...
      definition: {
        ...
        ...(field.definition instanceof DyadFieldDef && { sideA: field.definition.sideA, sideB: field.definition.sideB }),
...
describe('CreateAnnotationFieldUseCase', () => {
  ...
  beforeEach(() => {
    ...
    jest.clearAllMocks()
    createAnnotationFieldUseCase = new CreateAnnotationFieldUseCase(mockFieldRepo)
  })
  ...
  it('should create and save an annotation field', async () => {
    ...
    expect((savedField.definition as DyadFieldDef).sideA).toBe(input.definition.sideA)
    expect((savedField.definition as DyadFieldDef).sideB).toBe(input.definition.sideB)
  ...
  it('should throw an error for invalid definition type', async () => {
    ...
    await expect(createAnnotationFieldUseCase.execute(input))
      .rejects
      .toThrow('Invalid or unknown field definition type: app.annos.annotationField#unknownDef')
