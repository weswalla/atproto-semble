          ...
          <Container size={'xl'} p={'md'} my={'auto'}>
            <Stack align="center" gap={'5rem'}>
              ...
              >
                <Stack gap={'xs'}>
                  ...
                  <Text>
                    ...
                    <Text fw={500} fz={'lg'} c={'dark.2'} span>
                      Collect interesting links, add notes, and organize them
                      into shareable collections. Build trails others can
                      explore and extend.
                    </Text>
                  </Text>
                </Stack>
                ...
                <Stack gap={'xs'}>
                  <Image
                    src={BigPictureIcon.src}
                    alt="Big picture icon"
                    w={28}
                  />
                  <Text>
                    <Text fw={600} fz={'lg'} span>
                    ...
                    <Text fw={500} fz={'lg'} c={'dark.2'} span>
                      Find relevant research based on your network. Get the
                      extra context that matters before you dive into a long
                      read.
                    </Text>
                  </Text>
                </Stack>
